...
const Panelheader = [
  {
    num: "01",
    title: "Technologies We Use for eCommerce App Development ",
    decs: "We employ cutting-edge technologies tailored to elevate your eCommerce solutions. From mobile-first design and responsive interfaces to advanced AI integration and blockchain security, our approach ensures seamless performance and user-centric experiences across all platforms."
  },
];
