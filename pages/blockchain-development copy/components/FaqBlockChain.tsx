...
const Frequently = [
  {
    num: "1",
    title: "How much does it cost to build blockchain software development services?",
  ...
  {
    num: "2",
    title: "Can I Ask for Custom Blockchain Development Services?",
  ...
  },
  {
    ...
    desc: "Blockchain Development Company based in Jaipur, India is transforming various industries, and majorly the future lies in the Cybersecurity industry. Blockchain Development is an open source and distributed network; which keeps the data fully secured and verified. Blockchain Development Organizations do need such technology in future for optimum security and scalability features in it.",
  },
  {
    num: "4",
    title: "How Do I Choose the Best Blockchain Development Company in Jaipur, Rajasthan India?",
    desc: "If you are looking for best blockchain development company in the In India then here are a few things you must consider to find the righteous and suitable best blockchain app development service company-",
    ...
    li6: "Blockchain Development Service Offers Blockchain Consultation Services",
  },
  {
    num: "5",
    title: "What are the Benefits of Hiring the Blockchain Development Company in India? ",
    desc: "Hiring Blockchain Development Company in India, Blockchain Development Services improves trust, transactional security, transparency and incur in appropriate data sharing across the entire business development network. The decentralized services are experienced and skilled in blockchain development. Companies have professional trained blockchain experts qualified to provide seamless and secured decentralized solutions.",
  },
  {
    num: "6",
