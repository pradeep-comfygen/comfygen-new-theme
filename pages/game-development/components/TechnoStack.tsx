...
const AndroidApp = [
  ...
  alt: 'HITECH',
   title: "HITECH",
   pera:"We develop healthcare apps compliant with the HITECH electronic health record (EHR) system to support your applications with the latest technology.    ", 
   url: "#", 
   num: "1" },
...
const CrossApp = [
  ...
  // img: "/img/push-notifications-and-chat.webp",
   url: "#", 
   title: "FDA" ,
   pera:"We develop the mobile apps, which adheres the guidelines and standards of FDA, and also approved by the Food and Drug Administration Authority. ", 
  },
...
const Panelheader = [
  {
    num: "01",
    title: "Healthcare App Development Committed to Medical Compliances ",
    decs: "We have years of experienced healthcare app developers, who build custom healthcare solutions following all medical compliances. Our practices adhere legal guidelines and policies to build best medical apps: "
  },
];
