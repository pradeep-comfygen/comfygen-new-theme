          ...
          <section className="px-3 lg:px-14 py-2 lg:py-20">
            <div className="container flex flex-col justify-center p-4 mx-auto space-y-8 lg:space-y-0 lg:space-x-12 lg:justify-between lg:flex-row">
              <div className="flex flex-col space-y-4 text-center lg:text-left">
                <h3 className="xl:text-4xl  text-3xl font-bold  text-white">Get in Touch with Our Experts </h3>
                <p className="xl:text-lg text-base text-white">Want to find out how Comfygen can help your company develop a sports betting app? We can explain it to you.</p>
              </div>
