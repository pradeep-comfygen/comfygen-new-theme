...
const BlockchainStack = [
  ...
  { img: "/img/flutter.webp", alt: 'Flutter', title: "Flutter", url: "/flutter-development-company", num: "5", },
...
const ProgrammStack = [
  { num: "1", img: "/img/ios-apple.svg", url: "/ios-app-development", title: "iOS" },
  { num: "2", img: "/img/android-os.svg", url: "/android-app-development", title: "Android", },
...
const Panelheader = [
  {
    num: "01",
    title: <h2 className='py-4 text-[#fff] xl:text-4xl text-3xl font-bold xl:leading-[3rem] capitalize'> Comfygen Develop Sports Betting App Using <span className='text-blue-500'>The Latest Technology Stack </span> </h2>,
  },
];
