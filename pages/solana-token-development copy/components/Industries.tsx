      ...
      <div className="flex flex-col-reverse items-center mx-auto space-y-10 2xl:w-9/12 xl:w-5/6 w-11/12 lg:flex-row md:space-x-10 md:space-y-0">
        <div className="w-full space-y-6 text-left">
          <div className="space-y-4">
            ...
            <p className="text-base text-black">If you don’t know how to create a Solana token online, then we can come to the rescue. You can trust our experts for a straightforward approach to creating Solana tokens for your different use cases. Solana blockchain app devlopment offers a broad range of advantages to help you create solana token online according to your specific requirements. </p>
