...
const Panelheader = [
  {
    num: "01",
    title: <h2 className='py-4 text-[#fff] xl:text-4xl text-3xl font-bold xl:leading-[3rem] capitalize'> Technology Stack for Doctor Appointment Booking Apps </h2> ,
    decs: "Wanna build a doctor appointment booking app? Well gather the technologies to use and build a robust application " ,
    decs1: "The technology stack that is used when creating doctor appointment application development must deliver exceptional performance and scalability. The technology stack needed for constructing an online doctor booking app may vary depending on the project's complexity and desired features. Although there are many technology stacks that have to be integrated into healthcare application development, the following are fundamental. Our experts at the doctor appointment mobile app development company suggest the following solutions:"
  },
];
