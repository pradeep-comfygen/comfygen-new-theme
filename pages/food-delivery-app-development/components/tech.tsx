...
const backend = [
  ...
  {
    img: "/svg/tech/googlecloud-original.svg",
    alt: 'Googlecloud',
    name: "Ride Details",
    desc: " In the custom taxi app, the customers will receive ride details, required driver’s personal information, and his contact number for the convenience of customers to get safe drive.",
    num: "2"
  },
  {
    img: "/svg/tech/azure-original.svg",
    alt: 'Azure',
  ...
  {
    img: "/svg/tech/nginx-original.svg",
    alt: 'Nginx',
    name: "Multiple Payment Gateways",
    desc: "The customers have access to multiple payment gateways, through which they can pay for their rides. Even the taxi booking app has an in-app wallet to pay while booking the ride. ",
    num: "4"
  },
  {
    img: "/svg/tech/digitalocean-original.svg",
    alt: 'Digitalocean',
  ...
  {
    img: "/svg/tech/mysql-original-wordmark.svg",
    alt: 'Mysql',
    name: "Push Notifications:",
    desc: "The cab booking app will showcase you the notifications all the time for every update; whether the ride is coming, till when it will reach, is there any delay, ride accepted, ride canceled, and about every single update.  ",
    num: "6"
  }
      ...
      <section className="py-20  bg-slate-100">
        <div className=" space-y-10 mx-auto 2xl:w-9/12 xl:w-5/6 w-11/12">
          <div className=" py-4">
            ...
            <p className="text-[#0E1F51] text-center mt-2 text-base">Boost your taxi booking mobile application with some important and needed features based on the market standards. Our on demand taxi app development company adheres all the features to make your app competitive: </p>
          </div>
