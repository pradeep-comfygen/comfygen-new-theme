...
export default function HeroSectionForApplicationConsult(props: any) {
        ...
        <div className="space-y-6">
          ...
          <ul className="text-white/80 space-y-2">
            <li className="flex items-center gap-2 text-base font-normal ">
              {" "}
              <img className="w-8 h-8" src="/img/list-icon.svg" alt="" />{" "}
              Influential Mobile App Development Consultancy
            </li>
            <li className="flex items-center gap-2 text-base font-normal ">
              {" "}
              <img className="w-8 h-8" src="/img/list-icon.svg" alt="" />{" "}
              Fulfill Business and User’s Perspective
            </li>
            <li className="flex items-center gap-2 text-base font-normal ">
              {" "}
              <img className="w-8 h-8" src="/img/list-icon.svg" alt="" />
              Strategic Plans for Mobile App Development
            </li>
            <li className="flex items-center gap-2 text-base font-normal ">
              {" "}
              <img className="w-8 h-8" src="/img/list-icon.svg" alt="" /> Unique
              App Development Ideas with Innovative Approaches
            </li>
          </ul>
          <p className="w-full mx-auto text-sm font-light text-white/80 lg:text-base">
            {props.ptag3}
