...
const sections = [
  {
    title: "DPOS apps for Block producers",
    description: "DPOS blockchain apps that help manage nodes and blockchain use are created for block producers. ",
    items: [
      "Node Management Tools ",
      "Governance voting interfaces"
    ],
    bgColor: "bg-[#F1C37F]",
    imgSrc: "/img/dpos-apps-for-block-producers.svg",
    imgAlt: "DPOS apps for Block producers"
  },
  {
    title: "For token holders",
    description: "For token holders who want to use blockchain apps for different purposes, we also create apps that help utilize the blockchain algorithms. ",
    items: [
      "Staking platforms",
      "Voting apps "
    ],
    bgColor: "bg-[#3B82F6]",
    imgSrc: "/img/for-token-holders.svg",
    imgAlt: "For token holders"
  },
  {
    title: "For Blockchain Developers ",
    description: "We also create apps and frameworks for developers who want to specialize in blockchain development and use the technology in applications.",
    items: [
      "Smart Development contracts",
      "Development frameworks"
    ],
    bgColor: "bg-[#B463C0]",
    imgSrc: "/img/for-blockchain-developers.svg",
    imgAlt: "For Blockchain Developers "
  }
];
...
function Responsive() {
  ...
  return (
    <div className="slider-container bg-[#222222] lg:py-16 py-8">
      <div className="w-11/12 mx-auto 2xl:w-9/12 xl:w-5/6">
        <h2 className="md:text-4xl text-2xl md:font-bold font-semibold md:leading-[3rem] text-[#fff] text-center">
        DPOS Blockchain Development Solutions for Blockchain Service Providers
        </h2>
        <p className="text-base text-white text-center">
        We specialize in DPOS Blockchain Development and create DPOS blockchain apps for multiple purposes. Our development experts can help you create the following variations in DPOS apps.
        </p>
      </div>
      <Slider {...settings} className="md:m-10 m-5">
