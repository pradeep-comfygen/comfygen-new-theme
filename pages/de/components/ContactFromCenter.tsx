...
class ContactFromHeader extends Component<{}, any> {
  ...
  render() {
    ...
    return (
      <form onSubmit={this.handleValidationContactUs} className="bg-white rounded-xl lg:p-6 md:p-6 p-8 shadow-xl py-10  space-y-4 text-left   lg:w-[65%] w-full mx-auto lg:hidden block">
        <div>
