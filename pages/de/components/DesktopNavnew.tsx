...
const FullStackDev = [
  ...
  { num: "7", name: "React Native Development", url: "/react-native-development",},
  { num: "8", name: "Python Development", url: "/python-development" },
];
...
const Hire = [
  ...
  { num: "11", name: "Hire Blockchain Developer", url: "/hire-blockchain-developer"}
        ...
        <div
          ...
          <div className="block space-x-4 text-sm font-medium 2xl:space-x-4 lg:flex lg:items-center lg:space-y-0 lg:p-0">
            ...
            <div className="relative group ">
              ...
              <div className="z-40 lg:pt-0 pt-2 mt-[10px] lg:bg-white rounded-2xl bg-transparent capitalize text-gray-700 lg:absolute top-20 lg:drop-shadow-xl lg:border whitespace-nowrap relative  -left-80 transform hidden group-hover:block   transition duration-200 ease-in-out origin-top w-[60rem]">
